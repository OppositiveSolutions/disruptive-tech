...
public class AnnouncementController {
	...
	public Response deleteAnnouncement(HttpServletRequest request, HttpServletResponse response,
			@PathVariable("id") Integer id) throws Exception {
		service.deleteAnnouncement(id);
		return Response.ok().message(UIMessages.ANNOUNCEMENT_DELETED).build();
	}
