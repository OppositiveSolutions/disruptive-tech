...
public interface StaffRepository extends JpaRepository<Staff, Integer> {
    ...
    @Query(value = "SELECT new com.careerfocus.model.response.StaffVO(u.userId, CONCAT(u.firstName, ' ', u.lastName), "
            + "u.createdDate, s.joiningDate, u.username, p.phoneNo, s.status) FROM Staff s INNER JOIN s.user u "
    ...
    @Query(value = "SELECT new com.careerfocus.model.response.StaffVO(u.userId, CONCAT(u.firstName, ' ', u.lastName), "
            + "u.createdDate, s.joiningDate, u.username, p.phoneNo, s.status) FROM Staff s INNER JOIN s.user u LEFT JOIN u.userPhones p "
